/*
抓xfkd.yichengwangluo.net中请求包的Authorization和device


青龙格式export xfkdapp='Authorization#device'

cron: 1 6 * * *

*/
const $ = new Env("幸福看点");   // 1.名字改了
const ckName = "xfkdapp";           // 2. 英文名字改一下
const { log } = console;
//-------------------- 一般不动变量区域 -------------------------------------      // 3. 不用管 
...
let envSplitor = ["@", "\n"];
let ck = msg = ''
let hosts='https://xfkd.yichengwangluo.net'
